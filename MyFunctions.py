...
class RastriginFunction(FloatProblem):
    def __init__(self, number_of_variables: int = 10):
        ...
        self.lower_bound = [-100 for _ in range(number_of_variables)]  # Dolna granica zmiannych
        self.upper_bound = [100 for _ in range(number_of_variables)]  # Górna granica zmiennych
